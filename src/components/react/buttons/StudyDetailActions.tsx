        ...
        <div className="flex flex-col gap-4">
            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                <div className="flex items-end gap-1 mb-6 justify-center">
                    ...
                    <span className="text-4xl font-black text-green-ligth tracking-tight">
                ...
                <div className="space-y-3">
                    <Button
                        ...
                        text={isAlreadyInCart ? "En la cotización" : "Agregar a la cotización"}
                        icon={isAlreadyInCart ? <CheckCircle2 className="w-5 h-5 ml-2" /> : <ShoppingCart className="w-5 h-5 ml-2" />}
                    />
            ...
            <div className="bg-greenSecondary/5 p-6 rounded-[2rem] border border-greenSecondary/10">
                <h4 className="font-bold text-black mb-2 text-sm uppercase tracking-wider">¿Tienes dudas?</h4>
                <p className="text-xs text-grey mb-4">
                    Si necesitas más información sobre este estudio o quieres agendar una cita directamente.
                </p>
                <a 
                    href="/contact" 
