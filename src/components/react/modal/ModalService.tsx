                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="rounded-2xl border border-green-primary/15 bg-green-primary/5 p-4">
                                    ...
                                    <p className="mt-1 text-xs text-neutral-600 sm:text-sm">
                                        Podemos orientarte para elegir el estudio o servicio ideal según tu necesidad.
                                    </p>
                                </div>

                                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                                    <a href="/" className="inline-flex items-center justify-center transition hover:scale-105 active:scale-95">
                                        <img src={whatsappIcon.src} alt="WhatsApp DYRA" className="w-9 h-auto" />
                                    </a>
                                    <a href="/" className="inline-flex items-center justify-center transition hover:scale-105 active:scale-95">
                                        <img src={gmailIcon.src} alt="Email DYRA" className="w-9 h-auto" />
                                    </a>
                                </div>
